...
export class DataType {
	...
	static objectFromJson(json) {
		return new DataType(json.pet_id, json.name, json.age, json.sex, json.breed, json.img)
	}

	toString() {
		return `ID: ${this._id}, name: ${this._name}, age: ${this._age}, sex: ${this._sex}, 
		breed: ${this._breed}, image: ${this._img}`
	}
}
